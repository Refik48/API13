...
import com.tp.pojos.DataPojo;
import com.tp.pojos.EmployeePojo;
    ...
    */
     ...
     public void test(){
         ...
         DataPojo data=new DataPojo(1,"Tiger Nixon",320800,
                 61,"");
         EmployeePojo expectedData=new EmployeePojo("success",data,
        ...
        // urettigim obje uzerinde toJson method'unu kullandim

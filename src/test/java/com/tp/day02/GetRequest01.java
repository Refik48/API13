   ...
   ve girilen yaslar icinde 21, 61, ve 23 degerlerinden birinin oldugunu test edin
    ...
    public void test() {
        ...
        response.then().assertThat().
                ...
                body("data.id", hasSize(24), // data'nin icinde 24 tane mi id var ?
                        "data.employee_name",hasItem("Ashton Cox"), // data'nin icinde bu isim var mi ?
                        "data.employee_age",hasItems(21,61,23)); // age'lerde 21,61,23 var mi ?

...
public class GetRequest02 extends TestBaseDummy {
  /*
   ...
   */
    ...
    public void test() {
        ...
        Assert.assertEquals(24,json.getList("data.id"));
        ...
        // Boyle olur mu ? Olur fakat daha fazla oldugunda tek tek yazmak zahmetli olur.
        // Bunun yerine daha dinamik bir hale getirmek icin :
        ...
        // containsAll bir collection cagirir ve icerisine bir collection yazmamiz gerekmektedir.

...
public class GetRequest04 {
    ...
    // Matcher class : Api da response u verify etmek için farklı yöntemler vardır.
    // Bu yöntemlerden en temel olanı Matcher class dır.
    // Matcher class dendiğinde bunun assertthat ifadesi ile kullanıldığı gelmeli.
}